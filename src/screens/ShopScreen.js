...
export const ShopScreen = ({ navigation }) => {
    ...
    const [redeemLoading, setRedeemLoading] = useState(null); // Track loading per item
    ...
    const checkMembership = async () => {
        try {
            ...
            setIsPremium(profile.is_premium_member);
        } catch (error) {
            ...
            >
                <SafeAreaView style={styles.safeArea}>
                    <View style={styles.loadingContainer}>
                        ...
                        <Text style={{ color: theme.colors.white, marginTop: 10 }}>Loading Shop...</Text>
                    </View>
                </SafeAreaView>
            </LinearGradient>
        );
                ...
                <SafeAreaView style={styles.safeArea} edges={['top']}>
                    ...
                    <View style={styles.lockedContainer}>
                        ...
                        <Text style={styles.lockedText}>
                            Unlock the Shop to redeem exclusive rewards and offers.
                            One-time payment of $5 for lifetime access.
                        </Text>
                        <TouchableOpacity
